...
<body class="bg-background text-on-surface font-poppins w-screen h-screen">
    <section class="container p-4 h-full mx-auto flex items-center justify-center">
        <div class="w-full max-w-[30rem] grow rounded-xl bg-surface shadow-lg p-4 mb-20">
            ...
            <div class="flex items-center w-full text-xl p-2 rounded-lg outline-2 outline-outline">
                <h2 id="device-ulid" class="grow text-center font-semibold overflow-x-hidden">{{ $device->ulid }}</h2>
                <button class="material-symbols-outlined cursor-pointer p-2" onclick="copyUlid()">content_copy</button>
            </div>
